		...
		<div class="row">
			<div class="col-md-6">
				<div class="contact-info">
					<h3 class="sub-head">{!! $custom_order[0]->{'description_'.strtolower(app()->getLocale())} !!}</h3>
					<img src="{{URL( $custom_order[0]->image)}}"></iframe>
<p>{!! $custom_order[0]->{'description_'.strtolower(app()->getLocale())} !!}</p>
			...
			<div class="col-md-6 pull-right">
				...
				<div class="form">
					...
					@endif
					  {!!Form::open(array('action' => 'custom_order_formController@store'))!!}
